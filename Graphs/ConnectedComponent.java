 ...
 * graph에서 서로 다른 connected components들의 수를 세는 클래스
...
class Graph<E extends Comparable<E>> {
	 ...
	 * connected components를 계산하는데 사용되는 주 메소드.
	 * 깊이 우선 탐색을 수행하기 위해 노드 배열을 반복하여 실제 노드에서 그래프의
	 * 모든 노드를 가져옵니다. 이러한 노드는 markedNodes 배열에 추가되며 노드 목록에서
	 * 노드가 선택되면 무시됩니다.
