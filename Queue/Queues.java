 ...
 *   
 * 큐는 먼저 들어온 원소가 가장 먼저 삭제되게 하는 자료구조입니다. (First In First out)
 * 일상생활에서 큐와 유사한 예를 찾아보면, 먼저 선 사람이 먼저 나가게 되는 줄, 먼저 표를 뽑은 사람이 앞 순서를 가져가는 번호표 등이 있습니다.
 * 큐는 배열로도 구현할 수 있고, 연결 리스트로도 구현할 수 있습니다. 
 * 이 코드 내에서는 배열을 이용하여 큐를 구현하고 있습니다. 
 *
 * @author Unknown
 *
 */
